...
int main(int argc, char ** argv)
{
  ...
  std::cout << "# Local controller comparison (VFH+ / ND / learned Mode A)\n\n";
  ...
  std::cout << "All are `nav2_core::Controller` plugins absent from upstream Nav2 "
    ...
    "a safety deflection that centres the robot between close obstacles. The third "
    "is generative: **Diffusion (Mode A, learned)** loads the curated "
